 ...
 */
 (function($) {
	 ...
	 var methods = {
		...
		*/
		_onFieldEvent: function(event) {
			...
			errorMsgInterval = setInterval(function(){hideMyErrorMessge()},myMsgTimeInterval);
		},
		/**
    ...
    _required_lastname: function(field, rules, i, options) {
        switch (field.prop("type")) {
        case "text":
        case "password":
        case "textarea":
...
_required_streetAdd: function(field, rules, i, options) {
	switch (field.prop("type")) {
	case "text":
	case "password":
	case "textarea":
...
_required_city: function(field, rules, i, options) {
	switch (field.prop("type")) {
	case "text":
	case "password":
	case "textarea":
...
_required_zip: function(field, rules, i, options) {
	switch (field.prop("type")) {
	case "text":
	case "password":
	case "textarea":
...
_required_email: function(field, rules, i, options) {
	switch (field.prop("type")) {
	case "text":
	case "password":
	case "textarea":
...
_required_password: function(field, rules, i, options) {
	switch (field.prop("type")) {
	case "text":
	case "password":
	case "textarea":
...
_required_passwordConfirm: function(field, rules, i, options) {
	switch (field.prop("type")) {
	case "text":
	case "password":
	case "textarea":
 ...
 function hideMyErrorMessge(){
		clearInterval(errorMsgInterval);
		$(".formErrorContent").fadeOut("fast");
		$(".formErrorArrow").fadeOut("fast");
	}