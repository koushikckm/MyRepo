 ...
 * @version 1.0
 */
public class UserVehicleYearCodeResponseVO {

     private String error,description,status;
     private long lastchangetime;
     private List<UserVehicleYearCodeVO> vehicles;
    ...
    public List<UserVehicleYearCodeVO> getVehicles() {
		return vehicles;
	}

	public void setVehicles(List<UserVehicleYearCodeVO> vehicles) {
